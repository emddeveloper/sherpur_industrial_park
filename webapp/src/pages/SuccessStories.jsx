...
<h2 className="text-3xl font-headline font-bold text-primary tracking-tight">Steel Works Hub</h2>
</div>
...
<blockquote className="text-on-surface-variant text-base mb-8 leading-relaxed italic border-l-2 border-primary/20 pl-4">
                                "The specialized heavy-load flooring and high-clearance ceilings at Sherpur were non-negotiable for our manufacturing precision."
                            </blockquote>
<div className="flex items-center gap-4">
<div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white font-black">MD</div>
<div>
<p className="text-base font-bold text-primary">Marcus Dorn</p>
<p className="text-xs text-secondary font-medium uppercase tracking-wider">Director of Operations</p>
</div>
</div>
</div>
</div>
...
<h3 className="text-xs font-black uppercase tracking-[0.4em] text-secondary">Trusted by Global Leaders</h3>
</div>
...
<span className="material-symbols-outlined text-4xl" data-icon="factory">factory</span>
<span className="font-bold text-2xl font-headline tracking-tighter">METALOGIX</span>
</div>
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-4xl" data-icon="hub">hub</span>
<span className="font-bold text-2xl font-headline tracking-tighter">CONNECTO</span>
</div>
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-4xl" data-icon="package_2">package_2</span>
<span className="font-bold text-2xl font-headline tracking-tighter">PACK-PRO</span>
</div>
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-4xl" data-icon="bolt">bolt</span>
<span className="font-bold text-2xl font-headline tracking-tighter">ENERGIZE</span>
</div>
</div>
</div>
</section>
