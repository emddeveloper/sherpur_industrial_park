...
<h2 className="font-headline text-4xl font-extrabold text-primary mb-6 tracking-tight">Strategic Gateway</h2>
...
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-on-tertiary-container text-sm" data-weight="fill">location_on</span>
<span className="text-white font-headline font-bold text-xs uppercase tracking-tighter">Sherpur Junction</span>
</div>
</div>

<div className="absolute bottom-6 left-6 p-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/10 max-w-xs">
<div className="text-white text-[10px] uppercase tracking-widest font-bold mb-4 opacity-70">Infrastructure Legend</div>
<ul className="space-y-3">
<li className="flex items-center gap-3">
<div className="w-10 h-0.5 bg-on-tertiary-container"></div>
<span className="text-white text-xs font-medium">Primary Arterial Route</span>
</li>
<li className="flex items-center gap-3">
<div className="w-10 h-0.5 border-t-2 border-dashed border-white/50"></div>
<span className="text-white text-xs font-medium">Proposed Dedicated Rail Corridor</span>
</li>
</ul>
</div>
</div>
...
<h2 className="font-headline text-4xl font-extrabold text-primary mb-4 tracking-tight">The Logistics Dividend</h2>
<p className="text-secondary max-w-2xl mx-auto">Reduction in overheads through precision positioning. Our site is engineered for rapid intake and output.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">

<div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border-t-4 border-on-tertiary-container flex flex-col items-center text-center">
...
<h3 className="font-headline font-bold text-primary uppercase tracking-tight mb-4 text-xl">Trucking Efficiency</h3>
<p className="text-secondary font-body text-sm leading-relaxed">
                        Eliminate urban congestion delays with direct highway bypass access, saving an average of 45 minutes per outbound transit.
                    </p>
</div>

<div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border-t-4 border-primary flex flex-col items-center text-center">
<div className="w-16 h-16 rounded-full bg-surface-container mb-6 flex items-center justify-center">
<span className="material-symbols-outlined text-primary text-4xl">train</span>
</div>
<h3 className="font-headline font-bold text-primary uppercase tracking-tight mb-4 text-xl">Intermodal Speed</h3>
<p className="text-secondary font-body text-sm leading-relaxed">
                        Integration with the regional rail hub allows for seamless container movement from track to warehouse in under 30 minutes.
                    </p>
</div>

<div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.02)] border-t-4 border-primary flex flex-col items-center text-center">
<div className="w-16 h-16 rounded-full bg-surface-container mb-6 flex items-center justify-center">
<span className="material-symbols-outlined text-primary text-4xl">directions_boat</span>
</div>
<h3 className="font-headline font-bold text-primary uppercase tracking-tight mb-4 text-xl">Inland Port Access</h3>
<p className="text-secondary font-body text-sm leading-relaxed">
                        Proximity to the regional river terminal provides a sustainable and cost-effective alternative for heavy-bulk raw materials.
                    </p>
</div>
</div>
</div>
...
<h2 className="font-headline text-4xl font-extrabold text-primary mb-4 tracking-tight">Precision Distances</h2>
<p className="text-secondary">Verified travel times to key industrial nodes and commercial centers.</p>
</div>
...
<p className="text-on-primary-container text-lg max-w-2xl mx-auto mb-12">Join the elite network of industrial leaders who have optimized their operations through the Sherpur Advantage.</p>
